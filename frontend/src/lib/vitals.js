export const VITAL_TYPES = [
  { key: 'blood_glucose', name: 'Blood Glucose', unit: 'mg/dL', icon: 'Drop', color: '#0EA5E9', min: 20, max: 600, normalMin: 70, normalMax: 140, chartType: 'line' },
  { key: 'blood_oxygen', name: 'Blood Oxygen', unit: '%', icon: 'Wind', color: '#EF4444', min: 70, max: 100, normalMin: 95, normalMax: 100, chartType: 'area' },
  ...
  { key: 'respiratory_rate', name: 'Respiratory Rate', unit: 'breaths/min', icon: 'Wind', color: '#10B981', min: 5, max: 60, normalMin: 12, normalMax: 20, chartType: 'line' },
  ...
  { key: 'physical_activity', name: 'Physical Activity', unit: 'minutes', icon: 'PersonSimpleRun', color: '#0EA5E9', min: 0, max: 1440, normalMin: 30, normalMax: 120, chartType: 'bar' },
  { key: 'waist_circumference', name: 'Waist Circumference', unit: 'cm', icon: 'Ruler', color: '#EF4444', min: 40, max: 200, normalMin: 60, normalMax: 102, chartType: 'line' },
