...
export default function Login() {
  ...
  // Show error from failed Google auth redirect
      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
          ...
          <div className="relative mb-5">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-white px-3 text-[#94A3B8]">or sign in with email</span></div>
          </div>
